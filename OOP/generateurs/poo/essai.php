...
<body>
    <form method="post">
        <p><label>NOM DE LA CLASSE</label></p>
        <textarea rows="5" cols="50" id="classname" name="classname"><?= $classname ?></textarea>
        ...
        <p><label>LISTE DES ARGUMENTS CONSTRUCTEURS AVEC LEURS TYPES</label></p>
        <textarea rows="5" cols="50" id="arguments" name="arguments"><?= $arguments ?></textarea>
